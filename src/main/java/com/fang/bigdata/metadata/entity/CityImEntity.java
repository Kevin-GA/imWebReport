...
public class CityImEntity {
    ...
    public CityImEntity(String city, Integer indexPageUv, Integer listPageUv, Integer detailPageUv, Integer imCount, Integer sessionCount, Integer validSessionCount, Integer invalidSessionCount) {
        this.city = city;
